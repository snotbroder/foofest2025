...
function BurgerMenu() {
  ...
  return (
    <div className="bg-primary relative py-6 placeholder-main-1 px-8 md:px-0 mb-16 z-50 border-y-2 border-tertiary bg-[url('/img/filterbg.webp')] bg-no-repeat bg-cover">
      ...
      {openBurgerMenu ? (
        <nav className=" inset-0 relative h-full -z-10">
          <ul className="-mx-mobile  md:mx-0 font-rethink font-bold text-3xl flex flex-col items-end text-main-1 gap-10 py-8 px-8 absolute lg:px-32 bg-primary  bg-[url('/img/filterbg.webp')] bg-no-repeat bg-cover w-screen  ">
