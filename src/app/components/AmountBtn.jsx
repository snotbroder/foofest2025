...
function AmountBtn({ onAmountChange, maxAmount }) {
  ...
  return (
    <div className={`flex flex-col relative ${amount === maxAmount ? "after:content-['Max_selected_tickets'] after:absolute after:-bottom-4 after:left-0 after:text-main-1 after:text-xs " : ""}`}>
