  ...
  return (
    <article className="bg-[url('/img/filterbg.webp')] bg-cover -mt-16 ">
      <section className="bg-[url('/illustrations/patternHero.svg')] bg-cover -mx-mobile lg:-mx-desktop after:content-[''] after:h-1 after:bg-secondary after:w-full after:absolute after:opacity-60 ">
        <div className="pb-32 md:pb-2 mx-mobile lg:mx-desktop relative grid grid-cols-[2fr_1fr] ">
          ...
          <div className="row-[2/4]">
            ...
            <h2 className="text-2xl font-normal lg:w-1/2">
          ...
          <div className=" row-[1/5]">
            ...
            >
              <Image className="justify-self-end" src="/illustrations/flower2Green.svg" width={300} height={300} alt="green flower" />
            </motion.div>
            <motion.div
              className="hidden sm:block w-fit"
              whileInView={{ scale: 1 }}
              ...
              initial={{ scale: 0 }}
            >
              <Image className="justify-self-end" src="/illustrations/pink-flower.svg" width={200} height={200} alt="green flower" />
            </motion.div>
          </div>
        </div>
      </section>
