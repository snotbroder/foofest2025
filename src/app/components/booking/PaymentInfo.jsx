            ...
            <fieldset>
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col ">
                  <label>Email</label>
                  <input input="email" type="email" name="email" placeholder="e.g. john@doe.com" required></input>
                </div>
                <div className="flex flex-col">
                  <label>Name on Card</label>
                  <input type="text" name="name_on_card" placeholder="John" pattern="[A-Za-z]+" required></input>
                </div>
                <div className="flex flex-col">
                  <label>CardNumber</label>
                  <input type="text" name="card_number" placeholder="XXXX-XXXX-XXXX-1234" maxLength="16" min="16" required></input>
                </div>
                <div>
                  <label>MM / YY</label>
                  <div className="flex gap-2">
                    <input type="text" name="MM" className="w-1/5" placeholder="02" maxlength="2" required></input>
                    <p>/</p>
                    <input type="text" name="YY" className=" w-1/5 " placeholder="26" maxlength="2" required></input>
                  </div>
                </div>
                <div className="flex flex-col w-1/5">
                  <label>CVV</label>
                  <input type="text" name="cvv" placeholder="267" maxlength="3" minLength="3" required></input>
                </div>
              </div>
            </fieldset>
            <fieldset>
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col ">
                  ...
                  <input type="text" name="adress_1" placeholder="Fun street 1" required></input>
                </div>
                <div className="flex flex-col ">
                  <label>Adress Line 2</label>
                  <input type="text" name="adress_2" placeholder="Fun street 1"></input>
                </div>
                <div>
                  <div className="flex  flex-col md:flex-row lg:flex-col 2xl:flex-row gap-2">
                    <div className="flex flex-col">
                      <label>City</label>
                      <input type="text" name="city" placeholder="Copenhagen" required></input>
                    </div>
                    <div className="flex flex-col">
                      <label>Zip code</label>
                      <input type="text" name="zip_code" className="w-1/3" placeholder="2500" required></input>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {paymentType === "Mobilepay" && (
        <div className="flex flex-col gap-4">
          <form action="" className="flex flex-col gap-2 ">
            ...
            <input className="w-1/4" type="tel" inputMode="decimal" placeholder="XXXX3095" maxLength="8" required></input>
          </form>
          <button
            onClick={() => {
              setNewStep(step + 1);
