...
function TicketSelectParent() {
  ...
  return (
    <>
      ...
      <TicketSelectCard storedValue={storedValue} onAmountChange={(amount) => handleUpdate("regular ticket", amount)} ticketName="REGULAR TICKET" variant="regular" variantImage="regular-image" price="799"></TicketSelectCard>
      <button
        onClick={() => {
          if (totalTickets === 0) {
            console.log("no");
