    ...
    <div className=" w-44 md:w-60 lg:w-64 xl:w-80  flex flex-col shadow-custom ">
      <Link href={`/bands/${slug}`}>
        <div className="relative h-[130px]  md:h-[200px] lg:h-[220px]  xl:h-[260px]   ">
          <div className="absolute font-rethink  text-xs md:text-sm font-bold right-0 top-5 text-main-2 bg-tertiary uppercase py-1 px-5 z-10  ">
            <p>{genre}</p>
          </div>
          <Image
            className="fill"
        ...
        <div className="bg-primary h-16 flex justify-center items-center w-full   ">
          <h3 className="font-rethink font-extrabold uppercase text-main-1 text-center text-xl md:text-2xl py-5">
            {name}
          </h3>
        </div>
      </Link>
