      ...
      <section className="flex flex-col items-center gap-20">
        <div className="flex flex-wrap justify-center gap-4 items-center relative  md:gap-10 ">
          <div className="absolute -z-10 -top-36 left-0 mx-auto opacity-60 xl:-left-28">
            <Image src="illustrations/svg/flower2Pink.svg" width={250} height={250} objectFit="cover" alt="Pink Flower"></Image>
          </div>
          ...
          <div className="flex flex-wrap justify-center lg:justify-between gap-6 ">
            {bands.length > 0 &&
              bands.slice(0, 4).map((band) => {
                const logo = band.logo.startsWith("http") ? band.logo : `${BASE_URL}/logos/${band.logo}`;
